...
type ProviderServicesClient interface {
	ProviderSignUp(ctx context.Context, in *ProviderDataReq, opts ...grpc.CallOption) (*Res, error)
	ProviderLogin(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*Res, error)
...
func (c *providerServicesClient) ProviderSignUp(ctx context.Context, in *ProviderDataReq, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
...
func (c *providerServicesClient) ProviderLogin(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
...
type ProviderServicesServer interface {
	ProviderSignUp(context.Context, *ProviderDataReq) (*Res, error)
	ProviderLogin(context.Context, *LoginReq) (*Res, error)
...
func (UnimplementedProviderServicesServer) ProviderSignUp(context.Context, *ProviderDataReq) (*Res, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProviderSignUp not implemented")
}
func (UnimplementedProviderServicesServer) ProviderLogin(context.Context, *LoginReq) (*Res, error) {
...
func _ProviderServices_ProviderSignUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServicesServer).ProviderSignUp(ctx, req.(*ProviderDataReq))
	}
...
func _ProviderServices_ProviderLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServicesServer).ProviderLogin(ctx, req.(*LoginReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProviderServices_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "Provider/PB/provider.proto",
}
